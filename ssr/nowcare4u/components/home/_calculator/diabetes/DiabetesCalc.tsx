  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      <div className="flex items-center justify-between mb-4">
        ...
        <button onClick={() => router.push('/diabetes-records')} className="px-3 py-2 text-sm rounded bg-gray-100 hover:bg-gray-200">Records</button>
      </div>
