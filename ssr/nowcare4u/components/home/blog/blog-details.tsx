...
import { FaTwitter as Twitter, FaFacebook as Facebook, FaLinkedinIn as Linkedin } from "react-icons/fa";
...
const BlogDetail = () => {
  ...
  useEffect(() => {
    const fetchBlogPost = async () => {
      ...
      try {
        setLoading(true);
        const response = await fetch(`${API_BASE_URL}/blogs/getById/${blogId}`);
